// JavaScript Document
    ...
    var text_top = 20;
    var text_left = 50;
    var h = num_times*(size_y+pad) + pad + text_top;
    ...
    function visualizeit(data){
      ...
      var time = ["10:30","11:00","11:30","12:00","12:30","1:00","1:30","2:00","2:30","3:00","3:30","4:00","4:30","5:00","5:30","6:00","6:30","7:00","7:30","8:00","8:30","9:00"];
    ...
    function marginalGraph(marginal){
      ...
      var lineData = [];
      for(var i = 0; i < 16; i++){
        lineData[i] = {x:(time[i]-minimum)/(maximum-minimum)*200, y:i*(size_y + pad) + text_top + pad + size_y/2};
