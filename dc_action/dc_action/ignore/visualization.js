...
var chartMargin = {top: 30, right: 100, bottom: 30, left: 100};
...
function updateChart(data){
  ...
  var ethdata = [
    {
      name: "white", 
      under18: data.pop_nothisp_white_under18,
      over18: data.pop_nothisp_white
    },
    {
      name: "black",
      under18: data.pop_nothisp_black_under18,
      over18: data.pop_nothisp_black
    },
    {
      name: "hispanic",
      under18: data.pop_hisp_under18,
      over18: data.pop_hisp_under18
    },
    {
      name: "other",
      under18: data.pop_nothisp_other_under18,
      over18: data.pop_nothisp_other
    }
  ];
  ...
  console.log(chartSvg.selectAll(".label"));
...
function hoverNeighborhood(d) {
  ...
  if (d && all_data[d.properties.gis_id]){
    ...
    activeId = d.properties.gis_id;
    setVisMetric(activeData, all_data[activeId][activeData]);
    //console.log("Hover activeID = " + activeId);
  }
}
